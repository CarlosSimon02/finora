...
const AuthLayout = ({ children }: AuthLayoutProps) => {
  return (
    <>
      ...
      />
      <div className="flex min-h-[100dvh] flex-col lg:justify-center">
        <AuthHeader className="sticky top-0 z-10 w-full lg:hidden" />
        <main className="mx-auto flex w-full flex-1 lg:h-full">
